...
const Ejemplo2 = () => {
    ...
    /** Vamos a crear una referencia con useRef() para asociar una variable con un elemento del 
     * DOM del componente (cista HTML)*/
    const miRef = useRef();
     ...
     * En caso que cambie contador 2, no habrá ejecución
     */
    // useEffect(() => {
